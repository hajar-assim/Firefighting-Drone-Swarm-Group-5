...
class SchedulerTest {
    ...
    void tearDown() throws InterruptedException {
        ...
        schedulerQueue.put(new IncidentEvent("", 0, "EVENTS_DONE", "LOW", "(0;0)", "(0;0)", ""));
    ...
    void testMessageTransferFlow() {
        IncidentEvent fireEvent = new IncidentEvent("24:24:24",10,"FIRE_DETECTED","MODERATE","(24;24)","(1000;1001)","FireIncident");

        // Place the event
        schedulerQueue.put(fireEvent);
        IncidentEvent processedEvent = fireIncidentQueue.get();
